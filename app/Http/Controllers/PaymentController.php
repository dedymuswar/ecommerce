...
class PaymentController extends Controller
{
    public function notification(Request $request)
    {
        ...
        // if ($validSignatureKey){
        //     return response(['message' => 'ok'], 404);
        // }
    ...
    public function completed(Request $request)
    {
        ...
        \Session::flash('success', "Terima kasih, Pembayaran anda telah berhasil. Pesanan anda sedang di proses!");

        return redirect('checkout/received/' . $order->id);
    }
